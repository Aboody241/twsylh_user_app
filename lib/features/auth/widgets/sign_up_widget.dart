...
import 'package:twsylh_user/features/auth/domain/models/signup_body_model.dart';
                  ...
                  Row(children: [
                    ...
                    Expanded(
                      child: CustomTextField(
                        ...
                        countryDialCode: Get.find<SplashController>().configModel!.country ?? 'EG',
                        validator: (value) =>
                            ValidateCheck.validateEmptyText(value, "please_enter_phone_number".tr),
                      ),
                    ),

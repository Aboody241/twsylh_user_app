...
class ParcelViewWidget extends StatefulWidget {
  ...
  const ParcelViewWidget({super.key, required this.isSender, required this.nameController, required this.phoneController,
    ...
    this.guestEmailController, required this.senderAddressController, required this.receiverAddressController, this.orderNoteController});
...
class _ParcelViewWidgetState extends State<ParcelViewWidget> {
  ...
  final FocusNode orderNoteNode = FocusNode();
      ...
      return GetBuilder<ParcelController>(builder: (parcelController) {
        ...
        child: SizedBox(width: Dimensions.webMaxWidth, child: SingleChildScrollView(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: CustomTextField(
                        ...
                        inputType: TextInputType.text,
                        focusNode: floorNode,
                        nextFocus: widget.isSender ? orderNoteNode : nameNode,
            ...
            (widget.isSender && widget.orderNoteController != null) ? CustomCard(
              borderRadius: isDesktop ? Dimensions.radiusDefault : 0,
              isBorder: false,
              padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                CustomTextField(
                  ...
                  focusNode: orderNoteNode,
                  nextFocus: nameNode,
                  inputAction: TextInputAction.newline,
                ),
              ]),
            ) : const SizedBox(),
            ((widget.isSender && widget.orderNoteController != null) ? const SizedBox(height: Dimensions.paddingSizeLarge) : const SizedBox()),

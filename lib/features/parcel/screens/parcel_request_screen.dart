...
import 'package:twsylh_user/features/checkout/widgets/guest_create_account.dart';
import 'package:twsylh_user/features/parcel/widgets/from_to_address_card.dart';
import 'package:twsylh_user/features/parcel/widgets/parcel_payment_method_bottom_sheet.dart';
...
import 'package:twsylh_user/helper/string_extension.dart';
...
import 'package:twsylh_user/common/widgets/not_logged_in_screen.dart';
import 'package:twsylh_user/features/checkout/widgets/condition_check_box.dart';
import 'package:twsylh_user/features/checkout/widgets/tips_widget.dart';
import 'package:twsylh_user/features/parcel/widgets/card_widget.dart';
import 'package:twsylh_user/features/parcel/widgets/delivery_instruction_bottom_sheet_widget.dart';
import 'package:twsylh_user/features/parcel/widgets/details_widget.dart';
            ...
            if(parcelController.distance != -1 && parcelController.extraCharge != null) {
              ...
              if(checkoutController.isFirstTime){
                ...
                PlaceOrderBodyModel placeOrderBody = PlaceOrderBodyModel(
                  ...
                  orderAmount: charge, orderNote: parcelController.orderNote ?? '', orderType: 'parcel', receiverDetails: widget.destinationAddress,
